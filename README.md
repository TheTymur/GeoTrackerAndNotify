...
- Instalation 
1. In terminal or powershell write this: "pip install -r requirements.txt"
2. Create a file named .env in the 'Event_manager' folder and add your API key: "OPENCAGE_API_KEY=your_api_key_here"
3. You can run this application by command "python run.py"
...
After modifying your SQLAlchemy models, run the following command to detect changes and create a version file: "alembic revision --autogenerate -m "Describe your change here""

#### 2. Apply the Changes
To apply the pending migrations to the actual saved_reminders.db database: "alembic upgrade head"

#### How to revert changes
If you need to undo the last migration: "alembic downgrade -1"
